...
Route::middleware(['auth:sanctum', 'active_user'])->group(function (): void {
    ...
    Route::post('/items/{item}/files', [ItemController::class, 'updateFiles']);
    ...
    Route::post('/items/{item}/materials/sync', [ItemController::class, 'syncMaterials']);
    ...
    Route::post('/items/{item}/labor/sync', [ItemController::class, 'syncLabor']);
    ...
    Route::post('/items/{item}/machinery/sync', [ItemController::class, 'syncMachinery']);
