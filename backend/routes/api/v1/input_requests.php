...
Route::middleware(['auth:sanctum', 'active_user', 'db_permission:INSUMO,SOLICITUD|NUEVA_SOLICITUD'])->group(function (): void {
...
Route::middleware(['auth:sanctum', 'active_user', 'db_permission:INSUMO,GESTIONAR_SOLICITUD'])->group(function (): void {
