...
Route::middleware(['auth:sanctum', 'active_user'])->group(function (): void {
    ...
    Route::get('/projects/{project}/budget-recalculation/pdf', [ProjectController::class, 'budgetRecalculationPdf']);
    ...
    Route::get('/projects/{project}/input-breakdown/pdf', [ProjectController::class, 'inputBreakdownPdf']);
    Route::get('/projects/{project}/inputs-report/pdf', [ProjectController::class, 'inputsReportPdf']);
