...
use App\Http\Middleware\EnsureProjectModificationAccess;
...
Route::middleware(['auth:sanctum', 'active_user'])->group(function (): void {
    ...
    Route::post('/projects/{project}/template', [ProjectTemplateController::class, 'store'])->middleware(EnsureProjectModificationAccess::class);
    ...
    Route::put('/projects/{project}', [ProjectCatalogController::class, 'update'])->middleware(EnsureProjectModificationAccess::class);
    Route::post('/projects/{project}/items/sync', [ProjectItemsController::class, 'syncItems'])->middleware(EnsureProjectModificationAccess::class);
    ...
    Route::post('/projects/{project}/budget-recalculation', [ProjectBudgetController::class, 'budgetRecalculation'])->middleware(EnsureProjectModificationAccess::class);
    Route::get('/projects/{project}/budget-recalculation/pdf', [ProjectBudgetController::class, 'budgetRecalculationPdf'])->middleware(EnsureProjectModificationAccess::class);
    Route::get('/projects/{project}/budget-recalculation/xlsx', [ProjectBudgetController::class, 'budgetRecalculationXlsx'])->middleware(EnsureProjectModificationAccess::class);
    ...
    Route::post('/projects/{project}/breakdown-calculation', [ProjectBudgetController::class, 'breakdownCalculation'])->middleware(EnsureProjectModificationAccess::class);
