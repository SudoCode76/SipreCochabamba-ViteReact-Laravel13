...
- `text`
- `tipo`
- `precio` Mapa mental sobre los tipos de señales existentes.
...
- URL: `{
  ...
  "data": {
    "types": [
      {
        "id_tipo": 3,
        "descripcion": "EQUIPO MAQUINARIA Y HERRAMIENTAS",
        "estado": "AC"
      },
      {
        "id_tipo": 2,
    ...
    "unit_measures": [
      ...
      {
        "id_unidad_medida": 64,
        "descripcion": "metro (metro lineal)",
        "abreviatura": "m",
        "estado": "AC"
      },
      {
        "id_unidad_medida": 69,
        "descripcion": "METROS CÙBICOS",
        "abreviatura": "M3",
        "estado": "AC"
      },
      {
