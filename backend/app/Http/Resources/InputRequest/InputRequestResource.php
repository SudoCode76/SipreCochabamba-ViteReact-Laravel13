...
class InputRequestResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'latitud' => $this->when(isset($this->latitud), $this->latitud),
            'longitud' => $this->when(isset($this->longitud), $this->longitud),
            'distrito' => $this->when(isset($this->distrito), $this->distrito),
            'zona' => $this->when(isset($this->zona), $this->zona),
            'otb' => $this->when(isset($this->otb), $this->otb),
