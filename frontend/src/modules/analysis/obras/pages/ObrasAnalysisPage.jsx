...
export default function ObrasAnalysisPage() {
  ...
  const handleSubmitRecalculate = (e) => {
    ...
    if (reportWindow) {
      ...
      reportWindow.document.body.textContent = "Generando recalculo de precios unitarios Obras Publicas...";
    }
  ...
  const handleOpenUnitPriceAnalysisPdf = async (item) => {
    ...
    if (reportWindow) {
      reportWindow.document.title = "Generando PDF";
      reportWindow.document.body.textContent = "Generando analisis de precios unitarios Obras Publicas...";
    }
