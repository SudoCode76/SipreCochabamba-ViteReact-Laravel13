...
export const navigationSections = [
  ...
  },
  {
    ...
    icon: Blocks,
    children: [
      { title: "Item", path: "/items", icon: SquareChartGantt, accent: "emerald", permission: { className: "ITEMS", functions: ["INDEX"] } },
  ...
  },
  {
    ...
    icon: FolderKanban,
    children: [
      { title: "Nuevo proyecto", path: "/Nuevo proyecto", icon: Package, accent: "emerald", permission: { className: "PROYECTO", functions: ["REGISTRAR_PROYECTO"] } },
      { title: "Proyecto", path: "/Proyecto", icon: FolderKanban, accent: "sky", permission: { className: "PROYECTO", functions: ["INDEX"] } },
    ],
  },
  {
    title: "Insumo",
