...
export const navigationSections = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Unidad de Medida", path: "/parametros", icon: FolderKanban, accent: "sky" },
      ...
      { title: "% Calculo FPS", path: "/parametros", icon: FolderKanban, accent: "sky" },
      { title: "% Calculo FNDR", path: "/parametros", icon: FolderKanban, accent: "sky" },
      { title: "% OBRAS PUBLICAS", path: "/parametros", icon: FolderKanban, accent: "sky" },
